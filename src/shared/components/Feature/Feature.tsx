          ...
          <div className="row">
            ...
            <div className="col-xs-6 col-md-3">
              ...
              <p>
                ...
                enfrentar cualquier situación de riesgo, brindando un servicio de
                máxima calidad.
              </p>
            </div>
            <div className="col-xs-6 col-md-3">
              ...
              <p>
                ...
                utilizando sistemas inteligentes para la prevención y el monitoreo
                de riesgos.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-3">
              ...
              <h3><span className="count" data-count="253">0</span></h3>
              <p>PROJECTS LIKE</p>
            </div>
            <div className="col-md-3">
              <i className="fa fa-smile-o"></i>
              <h3><span className="count" data-count="252">0</span></h3>
              <p>HAPPY CLIENTS</p>
            </div>
            <div className="col-md-3">
              <i className="fa fa-anchor"></i>
              <h3><span className="count" data-count="1252">0</span></h3>
              <p>PROJECTS COMPLETED</p>
            </div>
            <div className="col-md-3">
              <i className="fa fa-user"></i>
              <h3><span className="count" data-count="52">0</span></h3>
              <p>EMPLOYEES</p>
            </div>
          </div>
        </div>
